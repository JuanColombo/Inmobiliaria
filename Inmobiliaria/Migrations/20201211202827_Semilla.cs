...
{
    public partial class Semilla : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "Colombo", 2, 20361962665.0, 0.0, 36196266, "Rafael Bonin 2874", "juampicolombosj@gmail.com", 1, new DateTime(1992, 1, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "San Justo", "Juan Pablo", 1, 3498463367.0 },
            ...
            migrationBuilder.InsertData(
                table: "Propietario",
                columns: new[] { "Id", "Apellido", "CondicionIva", "Cuil", "Cuit", "Dni", "Domicilio", "Email", "EstadoCivil", "FechaNacimiento", "Localidad", "Nombre", "Sexo", "Telefono" },
                values: new object[] { 1, "Parra", 2, 20361962595.0, 0.0, 36196259, "Juan Peron y Urquiza", "inmobiliariajuliandaniel@hotmail.com", 1, new DateTime(1992, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "San Justo", "Julian Daniel", 1, 3498526969.0 });
