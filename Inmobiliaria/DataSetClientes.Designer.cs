...
namespace Inmobiliaria {
    ...
    public partial class DataSetClientes : global::System.Data.DataSet {
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClienteRow AddClienteRow(string Nombre, string Apellido, int Dni, string Domicilio, double Cuil, double Cuit, System.DateTime FechaNacimiento, double Telefono, int Sexo, string Email, int EstadoCivil, string Localidad, int CondicionIva) {
        ...
        public partial class ClienteRow : global::System.Data.DataRow {
            ...
            public double Cuil {
                get {
                    return ((double)(this[this.tableCliente.CuilColumn]));
                }
                set {
                    this[this.tableCliente.CuilColumn] = value;
                }
            }
            ...
            public double Cuit {
                get {
                    return ((double)(this[this.tableCliente.CuitColumn]));
                }
                set {
            ...
            public double Telefono {
                get {
                    return ((double)(this[this.tableCliente.TelefonoColumn]));
                }
                set {
            ...
            public int CondicionIva {
                get {
                    return ((int)(this[this.tableCliente.CondicionIvaColumn]));
                }
                set {
                    this[this.tableCliente.CondicionIvaColumn] = value;
                }
            }
...
namespace Inmobiliaria.DataSetClientesTableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Cliente] WHERE (([Id] = @Original_Id) AND ([Dni] = @Original_Dni) AND ([Cuil] = @Original_Cuil) AND ([Cuit] = @Original_Cuit) AND ([FechaNacimiento] = @Original_FechaNacimiento) AND ([Telefono] = @Original_Telefono) AND ([Sexo] = @Original_Sexo) AND ([EstadoCivil] = @Original_EstadoCivil) AND ([CondicionIva] = @Original_CondicionIva))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Cliente] ([Nombre], [Apellido], [Dni], [Domicilio], [Cuil], [Cuit], [FechaNacimiento], [Telefono], [Sexo], [Email], [EstadoCivil], [Localidad], [CondicionIva]) VALUES (@Nombre, @Apellido, @Dni, @Domicilio, @Cuil, @Cuit, @FechaNacimiento, @Telefono, @Sexo, @Email, @EstadoCivil, @Localidad, @CondicionIva);
SELECT Id, Nombre, Apellido, Dni, Domicilio, Cuil, Cuit, FechaNacimiento, Telefono, Sexo, Email, EstadoCivil, Localidad, CondicionIva FROM Cliente WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cliente] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [Dni] = @Dni, [Domicilio] = @Domicilio, [Cuil] = @Cuil, [Cuit] = @Cuit, [FechaNacimiento] = @FechaNacimiento, [Telefono] = @Telefono, [Sexo] = @Sexo, [Email] = @Email, [EstadoCivil] = @EstadoCivil, [Localidad] = @Localidad, [CondicionIva] = @CondicionIva WHERE (([Id] = @Original_Id) AND ([Dni] = @Original_Dni) AND ([Cuil] = @Original_Cuil) AND ([Cuit] = @Original_Cuit) AND ([FechaNacimiento] = @Original_FechaNacimiento) AND ([Telefono] = @Original_Telefono) AND ([Sexo] = @Original_Sexo) AND ([EstadoCivil] = @Original_EstadoCivil) AND ([CondicionIva] = @Original_CondicionIva));
SELECT Id, Nombre, Apellido, Dni, Domicilio, Cuil, Cuit, FechaNacimiento, Telefono, Sexo, Email, EstadoCivil, Localidad, CondicionIva FROM Cliente WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nombre, Apellido, Dni, Domicilio, Cuil, Cuit, FechaNacimiento, Telefon" +
                "o, Sexo, Email, EstadoCivil, Localidad, CondicionIva FROM dbo.Cliente";
